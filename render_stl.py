...
STL_PATH = r"C:\Users\teeth.stl"
RENDER_OUT = r"C:\Users\dental_pipeline\teeth_render.png"
...
def setup_camera(obj):
    ...
    bpy.ops.object.camera_add(
        location=(dist * 0.8, -dist * 0.8, dist * 0.5)
    )
...
def run():
    print("=== Dental STL Render Pipeline ===\n")
    ...
    print("Applying enamel material...")
